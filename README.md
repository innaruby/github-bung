...
def process_sachaufwand_links(wb, file_path):
    ...
    for sheet in wb.worksheets:
        ...
        # Only compute Zwischensumme if the row is visible
        if zwischensumme_row and not sheet.row_dimensions[zwischensumme_row].hidden:
        ...
        if final_summe_row:
            summe_start_row = zwischensumme_row if zwischensumme_row and not sheet.row_dimensions[zwischensumme_row].hidden else 5
            summe_sum = sum_visible_rows(summe_start_row, final_summe_row)
